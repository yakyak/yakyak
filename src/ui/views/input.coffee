...
module.exports = view (models) ->
    div class:'input', ->
        ...
        div class:'input-container', ->
            ...
            , onkeydown: (e) ->
                if (e.metaKey or e.ctrlKey) and e.key.match('Up$')? then action 'selectNextConv', -1
                if (e.metaKey or e.ctrlKey) and e.key.match('Down$')? then action 'selectNextConv', +1
                unless isModifierKey(e)
                    ...
                    if e.target.value == ''
                        if e.key.match('Up$')? then historyWalk e.target, -1
                        if e.key.match('Down$')? then historyWalk e.target, +1
